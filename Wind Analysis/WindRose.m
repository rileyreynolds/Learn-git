...
%CHOOSE A TITLE FOR THE WIND ROSE 
TableTitle='Gabon 20.1-21.6 km';
...
lablegend        = 'Wind Speeds in m/10s';
colorfun         = 'jet';
...
if LegendType==2                                                           % If legend type is box:
    ...
    if isaxisempty                                                         % If axis were not specified
        ...
        set(l,'textcolor',TextColor,'color',figcolor);                     % change only the legend colour (text and background)
    end
